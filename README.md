...
- [imagemagick](https://www.imagemagick.org) `[CLI]` tools - Example: `magick image.jpg image.png` according to [official documentation](http://www.imagemagick.org/script/command-line-processing.php), but in Ubuntu commands from [graphicsmagick-imagemagick-compat](https://packages.ubuntu.com/xenial/all/graphicsmagick-imagemagick-compat/filelist) can be used, example: `convert image.jpg image.png`
