...
- [ods2md](https://github.com/kennytm/ods2md) `[CLI]` - CLI example: `ods2md.py input_file.ods > output_file.md`
...
- [imagemagick](https://www.imagemagick.org) `[CLI]` tools - `magick image.jpg image.png` according to [official documentation](http://www.imagemagick.org/script/command-line-processing.php), but in Ubuntu use commands from [graphicsmagick-imagemagick-compat](https://packages.ubuntu.com/xenial/all/graphicsmagick-imagemagick-compat/filelist), CLI example: `convert image.jpg image.png`
...
- [timidity](https://man.cx/timidity(1)) `[CLI]` - MIDI-to-WAVE converter and player - CLI example: `timidity -Ow name.mid`
