...
- [lame](https://man.cx/lame(1)) `[CLI]` - Create mp3 audio files - CLI usage: `lame sample.wav sample.mp3`
- [timidity](https://man.cx/timidity(1)) `[CLI]` - MIDI-to-WAVE converter and player - CLI usage: `timidity -Ow name.mid`
