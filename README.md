...
- [libreoffice](https://www.libreoffice.org) - Support for `.odt`,`.odp`,`.ods` and [other formats](https://help.libreoffice.org/Common/XML_File_Formats), and export/import of `.pdf` (however, if available, out-of-scope MS Word import of `.pdf` is worth a try).
